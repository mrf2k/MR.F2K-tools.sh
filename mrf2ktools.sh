...
echo -e  "Tools    : Mr.f2k $white         " |lolcat
echo -e  "Creadby  : Mr.f2k $white   " |lolcat
echo -e  "Contact  : 087775620119 $white " |lolcat
echo -e  "_____________________________________________________________"
...
6) echo "created by : mr.f2k" | lolcat
exit
;;
